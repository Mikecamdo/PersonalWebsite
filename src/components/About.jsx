                ...
                <Col ref={textRef} xs={12} lg={6} className={`my-auto ${loadText ? "notHidden3" : "hidden3"}`}>
                    ...
                    <Row className='text-center fs-4'>
                        <Col>
                            ...
                            I'm currently learning more about AI, Machine Learning, and Software Development, and I hope to utilize my skills to make a tangible impact on the problems that face our society today.
                        </Col>
                    </Row>
                </Col>
            </Row>
